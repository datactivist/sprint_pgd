...
![Sans métadonnées (Image par Araceli Jáuregui de Pixabay)](images/metadonnees_1.png "Sans métadonnées"){width="7cm"}

![Avec métadonnées (Image par heberhard de Pixabay)](images/metadonnees_2.png "Avec métadonnées"){width="7cm"}
