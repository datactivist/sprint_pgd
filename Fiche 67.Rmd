...
**Licences pour logiciels** : de façon schématique, il existe **trois degrés de copyleft** (*terme né d'un jeu de mots sur le terme copyright, et parfois traduit par «gauche d'auteur», désigne l'obligation de diffuser les œuvres modifiées sous la même licence que l'œuvre initiale*) pour les licences logiciels :
